...
export default function NavigationScreen() {
  ...
  // Smooth coordinate progression toward customer site
  React.useEffect(() => {
    let timer: any = null;
  ...
  return (
    <View style={[styles.container, { backgroundColor: activeBg }]}>
      ...
      <View style={[styles.header, { backgroundColor: darkMode ? 'rgba(15, 23, 42, 0.9)' : 'rgba(125, 160, 169, 0.95)' }]}>
        ...
        <Text style={styles.headerTitle} numberOfLines={1}>Navigation HUD (Web Preview)</Text>
        <View style={{ width: 60 }} />
      </View>

      {/* Top half: Map fallback Visualizer */}
